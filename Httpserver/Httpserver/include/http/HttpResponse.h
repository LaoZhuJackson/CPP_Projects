...
public:
    ...
    void closeConnection() const {return closeConnection_;}
    ...
    void setStatusLine(const std::string& version, HttpStatusCode statusCode,const string::strubg& statusMessage);
    void setErrorHeader(){}
