...
void Socket::bindAddress(const InetAddress& localaddr){
    if(0!=::bind(sockfd_,(sockaddr*)localaddr.getSockAddr(),sizeof(sockaddr_in))) LOG_FATAL<<"bind sockfd:"<<sockfd_<<"fail";
}

void Socket::listen(){
    if(0!=::listen(sockfd_,1024)) LOG_FATAL<<"bind sockfd"<<sockfd_<<"fail";
}
